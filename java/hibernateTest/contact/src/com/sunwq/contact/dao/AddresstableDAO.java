 ...
 * 
 * @see com.sunwq.contact.dao.Addresstable
 * @author MyEclipse Persistence Tools
 */

public class AddresstableDAO extends BaseHibernateDAO {
	private static final Log log = LogFactory.getLog(AddresstableDAO.class);
	// property constants
	...
	public Addresstable findById(java.lang.Integer id) {
		...
		try {
			Addresstable instance = (Addresstable) getSession().get(
					"com.sunwq.contact.Addresstable", id);
			return instance;
		} catch (RuntimeException re) {
	...
	public List findByExample(Addresstable instance) {
		...
		try {
			List results = getSession().createCriteria(
					"com.sunwq.contact.Addresstable").add(
